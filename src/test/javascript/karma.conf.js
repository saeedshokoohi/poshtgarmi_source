...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/scheduler/codebase/jdate.js',
            'src/main/webapp/bower_components/scheduler/codebase/dhtmlxscheduler.js',
            'src/main/webapp/bower_components/scheduler/codebase/locale/locale_en.js',
            'src/main/webapp/bower_components/scheduler/codebase/ext/dhtmlxscheduler_minical.js',
            'src/main/webapp/bower_components/scheduler/codebase/ext/dhtmlxscheduler_limit.js',
            'src/main/webapp/bower_components/scheduler/codebase/ext/dhtmlxscheduler_tooltip.js',
            'src/main/webapp/bower_components/wickedpicker/dist/wickedpicker.min.js',
            'src/main/webapp/bower_components/tooltipster/dist/js/tooltipster.bundle.js',
            'src/main/webapp/bower_components/please-wait/build/please-wait.js',
            ...
            'src/main/webapp/bower_components/angular-summernote/dist/angular-summernote.js',
            'src/main/webapp/bower_components/angular-wizard/dist/angular-wizard.min.js',
            'src/main/webapp/bower_components/angular-upload/angular-upload.js',
